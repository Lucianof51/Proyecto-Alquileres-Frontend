...
export class GaranteUpdatePage implements OnInit {
  ...
  constructor(private activatedRoute: ActivatedRoute, private garanteService: GarantesService, private router: Router, private alertCtrl: AlertController, private formBuilder: FormBuilder) { }
  id2: any;
  nombre2: any;
  apellido2: any;
  DNI2: any;
